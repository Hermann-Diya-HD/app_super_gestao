...
<html lang="pt-br">
    <head>
        ...
        <style>
            ...
            .redes-sociais, .area-contacto, .localizacao {
                width: 33.333%;
            ...
            .redes-sociais, .area-contacto, .localizacao p, span {
                color: #333333;
            }
    ...
    <body>
        ...
        <div class="conteudo-destaque">
            ...
            <div class="direita">
                <div class="contacto">
                    <h1>contacto</h1>
                    <p>Caso tenha qualquer dúvida por favor entre em contacto com nossa equipe pelo formulário abaixo.<p>
                    <form>
                        ...
                        <select class="borda-branca">
                            <option value="">Qual o motivo do contacto?</option>
